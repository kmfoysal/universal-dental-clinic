                ...
                <div className="container mx-auto">
                    <div className='flex items-center h-screen'>
                        <div>
                            ...
                            <Link to='/contact'><button className='py-3 lg:py-4 px-10 text-white rounded-full bg-gradient-to-r from-purple-500 to-indigo-500'>Book Appointment</button></Link>
