            ...
            <section className='hero-area'>
                <div className="container mx-auto">
                    <div className='flex items-center h-screen'>
                        <div>
                            <h2 className='lg:text-6xl leading-normal font-semibold text-gray-800 sm:text-xl'>A Brighter Dental</h2>
                             <h2 className='text-6xl font-semibold text-gray-800 mb-8 sm:text-3xl'>Experience</h2>
