        ...
        <div>
            <div className='grid lg:grid-cols-2 grid-flow-row gap-12 place-items-center'>
                <div className='lg:pl-32 px-4 text-center lg:text-left'>
                    ...
                    <button className='py-3 px-8 text-white rounded-full bg-gradient-to-r from-purple-500 to-indigo-500'>CALL NOW</button>
                </div>
                <div>
           ...
           <div className='m-2'>
            <div className='container lg:w-3/5 mx-auto lg:p-8 py-8 bg-white rounded-2xl my-10 shadow-2xl'>
                <h3 className='lg:text-5xl text-4xl font-semibold text-center mb-8'>Get in touch</h3>
                <div class="row mb-3">
                    <div class="col">
